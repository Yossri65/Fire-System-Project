...
# 21 "./ECU_Layer/Key_Pad/ecu_key_pad.h"
typedef struct
{
...
USART_CONFIG_t uart =
{
  ...
  .sync_async_mode = 0 ,
  .UART_TX_Enable.TX_Enable = 1 ,
  .UART_TX_Enable.TX_9Bit_Enable = 0,
  .UART_TX_Enable.TX_Interrupt_Enable = 1,

  .UART_RX_Enable.RX_Enable= 1,
  .UART_RX_Enable.RX_9Bit_Enable = 0,
  .UART_RX_Enable.RX_Interrupt_Enable = 1,
  .EUSART_FRAMINGERRORDefaultHandler = ((void*)0),
  .EUSART_OVERRUNERRORDefaultHandler =((void*)0),
...
int main(void) {
    ...
    while(1)
    {
        ...
        uint8 first_digit = 0 , Second_digit = 0 ,third_digit = 0;
