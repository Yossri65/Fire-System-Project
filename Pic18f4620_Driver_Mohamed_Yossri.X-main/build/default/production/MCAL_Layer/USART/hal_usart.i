...
static void EUSART_Baud_Rate_Calculation(const USART_CONFIG_t *_usart)
{
    ...
    switch(_usart->buad_rate_gen)
    {
        case BAUDRATE_ASYN_8BIT_lOW_SPEED:
            ...
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 0;
            baudrate_temp = ((8000000UL /(float)_usart->baudrate)/64) - 1;
        break;
        case BAUDRATE_ASYN_8BIT_HIGH_SPEED:
            TXSTAbits.SYNC = 0;
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 1;
            baudrate_temp = ((8000000UL /(float)_usart->baudrate)/16.0) - 1;
        ...
        case BAUDRATE_ASYN_16BIT_HIGH_SPEED:
            ...
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 1;
            baudrate_temp = ((8000000UL /(float)_usart->baudrate)/4) - 1;
        break;
